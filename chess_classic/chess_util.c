...
#define __PYX_HAVE__chess_util
#define __PYX_HAVE_API__chess_util
#include <string.h>
#include <stdio.h>
#include "pythread.h"
#ifdef _OPENMP
...
/* Module declarations from 'chess_util' */
#define __Pyx_MODULE_NAME "chess_util"
int __pyx_module_is_main_chess_util = 0;

/* Implementation of 'chess_util' */
...
static int *__pyx_f_10chess_util_attack(int *__pyx_v_a, int *__pyx_v_b) {
  int __pyx_v_result[2];
  int *__pyx_r;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("attack", 0);
  __Pyx_TraceCall("attack", __pyx_f[0], 11, 0, __PYX_ERR(0, 11, __pyx_L1_error));
 ...
 *         if a[0] > b[0] :
 */
  __pyx_t_1 = (((__pyx_v_a[1]) == (__pyx_v_b[1])) != 0);
  if (__pyx_t_1) {
 ...
 *         else:
 */
    __pyx_t_1 = (((__pyx_v_a[0]) > (__pyx_v_b[0])) != 0);
    if (__pyx_t_1) {
 ...
 *         if b[0]-a[0] > 0 :
 */
  __pyx_t_1 = ((((__pyx_v_b[0]) - (__pyx_v_a[0])) == ((__pyx_v_b[1]) - (__pyx_v_a[1]))) != 0);
  if (__pyx_t_1) {
 ...
 *         else:
 */
    __pyx_t_1 = ((((__pyx_v_b[0]) - (__pyx_v_a[0])) > 0) != 0);
    if (__pyx_t_1) {
 ...
 *         if b[0]-a[0] > 0 :
 */
  __pyx_t_1 = ((((__pyx_v_b[0]) - (__pyx_v_a[0])) == ((__pyx_v_a[1]) - (__pyx_v_b[1]))) != 0);
  if (__pyx_t_1) {
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("chess_util.attack", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initchess_util(void); /*proto*/
PyMODINIT_FUNC initchess_util(void)
#else
PyMODINIT_FUNC PyInit_chess_util(void); /*proto*/
PyMODINIT_FUNC PyInit_chess_util(void)
#endif
{
  __Pyx_TraceDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_chess_util(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("chess_util", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_chess_util) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "chess_util")) {
      if (unlikely(PyDict_SetItemString(modules, "chess_util", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("PyMODINIT_FUNC PyInit_chess_util(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init chess_util", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init chess_util");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
