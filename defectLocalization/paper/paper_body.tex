...
The performance of the VSM model is summarized in table \ref{performance_vsm}, we report the top k hit value with k equals 1,5 and 10.

 \begin{table}[h]
 	\begin{center}
 		\caption{Performance Of VSM with TF-IDF}
 		\label{performance_vsm}
 		
 		\begin{tabular}{c|l|l|l|l|l} %
 			\textbf{Project} & \textbf{Top 1} & \textbf{Top 5} & \textbf{Top 10} & \textbf{MRR} & \textbf{MAP}\\
 			\hline\hline
 			ZXing & 1(25\%)& 2(50\%) &4(100\%)& 43.125\% &39.27\%\\
 					
 			SWT & 1(5\%) & 6(30\%) & 10(50\%)& 19.46\% & 10.73\%\\
 			
 			AspecJ & 3(5.17\%)  & 15(25.86\%) &24(41.38\%) & 14.40\% & 5.74\%\\
 			
 			Eclipse &7(1.15\%) & 17(2.78\%)& 22(3.6\%) & 2.37\%& 1.17\%\\
